...
```
{
  ...
  description:
    "Protects the food from moisture entering or escaping the package."
},

{
  key: "gas_requirement",
  name: "Oxygen & gas protection",
  description:
    "Controls the movement of oxygen and other gases through the package."
},

{
  ...
  description:
    "Protects the food from potentially harmful light exposure."
},

{
  ...
  description:
    "Protects the food during handling, stacking and transportation."
},

{
  key: "sealability",
  name: "Ease of sealing",
  description:
    "Helps maintain a secure and leak-resistant package."
},

{
  ...
  description:
    "Checks whether the packaging is suitable for the selected storage temperature."
},

{
  ...
  description:
    "Checks whether the material is listed as suitable for food-contact use."
}
```
...
result.summary ||
"The AI ranking engine evaluated available packaging materials against the selected food and storage conditions.";

resultsMeta.textContent =
`${request.target_shelf_life} days · ` +
